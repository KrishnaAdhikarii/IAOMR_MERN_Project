        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 lg:justify-end">
            ...
            disabled
              ...
              className="bg-white text-[rgb(27,46,87)] px-6 py-3 rounded-2xl font-semibold shadow-md hover:bg-blue-50 cursor-not-allowed opacity-60 transition whitespace-nowrap"
            >
              📥 Download Template
            </button>
